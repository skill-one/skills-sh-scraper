...
from huaweicloudsdkas.v1 import AsClient, ShowWarmPoolRequest
...
parser = argparse.ArgumentParser(description='查询暖池信息')
...
def main():
    ...
    try:
        ...
        request = ShowWarmPoolRequest()
        request.scaling_group_id = args.scaling_group_id

        response = client.show_warm_pool(request)
