...
from huaweicloudsdkbms.v1.model import ShowMetadataOptionsRequest
...
# 参数
parser = argparse.ArgumentParser(description="查询裸金属服务器元数据配置")
...
try:
    ...
    print(f"bms.show_metadata_options 查询失败: {e}")
    exit(1)
