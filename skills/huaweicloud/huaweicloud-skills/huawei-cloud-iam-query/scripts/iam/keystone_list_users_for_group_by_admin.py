...
from huaweicloudsdkiam.v3.model import KeystoneListUsersForGroupByAdminRequest
...
parser = argparse.ArgumentParser(description="管理员查询用户组下用户 (v3)")
...
try:
    ...
    output = f"id	name	domain_id	enabled	description	pwd_status	password_expires_at\n"
    ...
    print(f"iam.keystone_list_users_for_group_by_admin 查询失败: {e}")
    exit(1)
