...
from huaweicloudsdkiam.v3.model import KeystoneListRegionsRequest
...
parser = argparse.ArgumentParser(description="查询区域列表 (v3)")
...
try:
    ...
    response = client.keystone_list_regions(request)
    ...
    output = f"id	description	parent_region_id	type\n"
    ...
    print(f"iam.keystone_list_regions 查询失败: {e}")
    exit(1)
