...
from huaweicloudsdkobs.v1.model import GetBucketPublicStatusRequest
from huaweicloudsdkobs.v1.region.obs_region import ObsRegion

AK, SK, Region, SecurityToken = load_credentials()

parser = argparse.ArgumentParser(description="获取桶公共状态")
...
try:
    request = GetBucketPublicStatusRequest()
    ...
    response = client.get_bucket_public_status(request)
    ...
    print(f"obs.get_bucket_public_status 查询失败: {e}")
    exit(1)
