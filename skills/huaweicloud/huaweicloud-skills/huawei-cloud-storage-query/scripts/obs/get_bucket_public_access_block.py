...
from huaweicloudsdkobs.v1.model import GetBucketPublicAccessBlockRequest
from huaweicloudsdkobs.v1.region.obs_region import ObsRegion

AK, SK, Region, SecurityToken = load_credentials()

parser = argparse.ArgumentParser(description="获取桶公共访问块配置")
...
try:
    ...
    response = client.get_bucket_public_access_block(request)
    ...
    print(f"obs.get_bucket_public_access_block 查询失败: {e}")
    exit(1)
