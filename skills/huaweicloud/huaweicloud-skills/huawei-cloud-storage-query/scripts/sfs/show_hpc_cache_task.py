...
from huaweicloudsdksfsturbo.v1.model import ShowHpcCacheTaskRequest
from huaweicloudsdksfsturbo.v1.region.sfsturbo_region import SFSTurboRegion

AK, SK, Region, SecurityToken = load_credentials()

parser = argparse.ArgumentParser(description="查询HPC缓存任务详情")
...
try:
    request = ShowHpcCacheTaskRequest()
    ...
    response = client.show_hpc_cache_task(request)
    ...
    print(f"sfs.show_hpc_cache_task 查询失败: {e}")
    exit(1)
