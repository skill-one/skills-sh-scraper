...
- 是否需要图示：{是 / 否；本字段指 Org example 图，表格另在案例记录中说明}
...
- 开头要回答的问题：{同时说明理解这个问题需要先分清的角色、对象或背景，正文如何交代}
...
- 缺失前提与处理：{评估者引用原句，写明理解主线时自行补了什么专业知识；写作者记录修改及复查结果。没有发现时如实说明；用户反馈未读懂时保留该反馈，不能沿用旧 PASS}
