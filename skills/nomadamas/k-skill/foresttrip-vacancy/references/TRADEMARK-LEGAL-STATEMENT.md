# 상표 사용 법적 고지 — `foresttrip-vacancy`

이 스킬에서 `숲나들e` 및 `Foresttrip` 명칭은 국립 자연휴양림 숙박·야영 예약 조회의 **대상 공식 서비스**를 식별하기 위해 사용한다. k-skill의 출처나 운영주체를 해당 서비스 운영기관으로 표시하려는 사용이 아니다.
