# DISCLAIMER — `olive-young-search`

이 스킬은 CJ올리브영·올리브영 또는 판매자의 공식 기능 또는 공식 지원 도구가 아니며, 공식 제휴·후원·승인·인증 또는 협업한 사실이 전혀 없습니다. 상표와 서비스명은 매장·상품·재고 조회 기능과 대상을 설명하기 위해서만 사용합니다.
...
- 공개 상품·재고정보 자동 수집은 반드시 개인의 정보 조회용으로만 사용합니다.
