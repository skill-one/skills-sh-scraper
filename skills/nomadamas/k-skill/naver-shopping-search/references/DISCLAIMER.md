# DISCLAIMER — `naver-shopping-search`

이 스킬은 네이버·네이버쇼핑 또는 판매자의 공식 기능 또는 공식 지원 도구가 아니며, 공식 제휴·후원·승인·인증 또는 협업한 사실이 전혀 없습니다. 상표와 서비스명은 상품·가격 조회 기능과 대상을 설명하기 위해서만 사용합니다.
...
- 출처 링크를 유지하고 접근통제·차단·rate limit을 우회하거나 정상 영업을 방해하지 않습니다.
