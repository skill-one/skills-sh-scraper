# DISCLAIMER — `kopis-performance-search`

이 스킬은 KOPIS·예매처·공연기획사 또는 자료 제공자의 공식 기능 또는 공식 지원 도구가 아니며, 공식 제휴·후원·승인·인증 또는 협업한 사실이 전혀 없습니다. 관련 상표와 서비스명은 공연정보 조회·예매 대상 설명을 위해서만 사용합니다.
...
- 공개 공연정보 자동 수집은 반드시 개인의 정보 조회용으로만 사용합니다.
- 조직적·대량 크롤링, 별도 DB 구축, 반복 좌석 선점이나 구매 자동화에 사용하지 않습니다.
- 접근통제·CAPTCHA·차단·rate limit을 우회하지 않으며 예매처의 정상 영업을 방해하지 않습니다.
