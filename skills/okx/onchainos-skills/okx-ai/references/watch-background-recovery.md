...
4. Only after the old task is confirmed exited or stopped, restart watch **in the foreground** per `watch-core.md` §Run watch (preserving sticky `--job-id <X>` per §Session-scoped sticky if applicable).
