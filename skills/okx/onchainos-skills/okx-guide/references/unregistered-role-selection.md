...
|---|---|---|
| `1` (User) | `Registering your User identity, hang tight... ⏳` | Enter through [`../../okx-ai/SKILL.md`](../../okx-ai/SKILL.md), then use [`identity/register.md`](../../okx-ai/references/identity/register.md) (role `User`) |
| `2` (ASP) | `Registering your ASP identity, hang tight... ⏳` | Enter through [`../../okx-ai/SKILL.md`](../../okx-ai/SKILL.md), then use [`identity/register.md`](../../okx-ai/references/identity/register.md) (role `ASP`) |
| `3` (Evaluator) | `Registering your Evaluator identity, hang tight... ⏳` | Enter through [`../../okx-ai/SKILL.md`](../../okx-ai/SKILL.md), then use [`identity/register.md`](../../okx-ai/references/identity/register.md) (role `Evaluator`) |
...
> When the reply names the Evaluator role with a legacy word (仲裁者 / 仲裁员 / 评估者 / arbiter / Arbitrator), enter through [okx-ai/SKILL.md](../../okx-ai/SKILL.md), then apply the [role-confirmation mapping rules](../../okx-ai/references/identity/register.md#1-role-confirmation) before routing.
