# Agent Compatibility — qwencloud-image-generation
...
|-------|-----------------|---------------|
| qwencloud-image-generation | generate image, poster, illustration, text-to-image | `{base}/qwencloud-image-generation/SKILL.md` |
