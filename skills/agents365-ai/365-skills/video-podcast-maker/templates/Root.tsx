...
export const videoSchema = z.object({
      ...
      titleSize: z
            ...
            .min(84)
            .max(120)
            .describe("标题字号 (hero/section title)"),
      ...
      transitionDuration: z
            ...
            .min(0)
            .max(30)
            .describe("转场时长(帧数, 30帧=1秒)"),

      // 方向设置
      orientation: z
            .enum(["horizontal", "vertical"])
            .describe("视频方向: horizontal(16:9) / vertical(9:16)"),

      // 图标设置
      iconStyle: z
            .enum(["lucide", "emoji", "mixed"])
            .describe("图标风格: lucide(SVG) / emoji / mixed"),
      iconAnimation: z
            .enum(["entrance", "none"])
            .describe("图标动画: entrance / none"),
});
...
const calculateVideoMetadata: CalculateMetadataFunction<VideoProps> = async ({
      ...
      return {
            durationInFrames:
                  timing.total_frames + trailingSilent * SILENT_FRAMES,
            props,
      };
};
