...
metadata:
  ...
  cangjie.capability-id: cap.naval.decision-heuristics
  cangjie.capability-revision: 1
  cangjie.bundle-id: bundle.naval-almanack
  cangjie.source-title: 《纳瓦尔宝典：财富与幸福指南》
  cangjie.tags: decision, heuristics, career, life-choice
---
<!-- capability_id: cap.naval.decision-heuristics | revision: 1 | status: active -->
<!-- 来源: books/naval-almanack-skill/decision-heuristics/SKILL.md（正文逐字保留） -->
