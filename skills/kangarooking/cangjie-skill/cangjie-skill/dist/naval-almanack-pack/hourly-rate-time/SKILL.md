...
metadata:
  ...
  cangjie.capability-id: cap.naval.hourly-rate-time
  cangjie.capability-revision: 1
  cangjie.bundle-id: bundle.naval-almanack
  cangjie.source-title: 《纳瓦尔宝典：财富与幸福指南》
  cangjie.tags: time, delegation, freedom, productivity
---
<!-- capability_id: cap.naval.hourly-rate-time | revision: 1 | status: active -->
<!-- 来源: books/naval-almanack-skill/hourly-rate-time/SKILL.md（正文逐字保留） -->
