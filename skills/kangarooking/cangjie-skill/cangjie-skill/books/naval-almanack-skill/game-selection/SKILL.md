...
name: game-selection
description: |
  当用户困惑「为什么有人攻击我/为什么大家卷来卷去/我怎么不在乎别人眼光/为什么妒忌」时调用。
  核心理念: 人生同时存在零和地位游戏、正和财富游戏、单人游戏; 识别你玩的是哪种游戏, 避免地位游戏, 回到内在记分卡。
  不适用于: 具体竞争策略制定（如何赢下某个比赛）。
  Triggers: 地位/攀比/内卷/妒忌/别人怎么看我/零和/单人游戏/status game/envy
source_book: 《纳瓦尔宝典：财富与幸福指南》 纳瓦尔·拉维坎特
source_chapter: 第二章·幸福 / 第一节 学习幸福 / 妒忌是幸福的敌人
tags: [status, zero-sum, happiness, psychology]
related_skills:
