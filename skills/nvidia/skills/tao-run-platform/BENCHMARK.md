# Skill Benchmark: tao-run-platform
...
- Dataset digest: `sha256:2cd7f2105e4b945a4568a5e8a120bf321aef2a461e889179abb233a9bd47acbb` (skill-evaluator-dataset-snapshot/1)
- Attempts per task: 1
...
|---|---:|---:|
| Overall | 23% → 100% (+77 points) | 33% → 43% (+10 points) |
...
- **MEDIUM** SCHEMA/frontmatter_field_placement: Root field 'tags' is ignored; use 'metadata.tags' (`skills/platform/tao-run-platform/SKILL.md`)
