...
Apache-2.0 <br>
## Use Case: <br>
Developers and engineers who need to submit and monitor GPU training jobs on supported platforms (Brev, SLURM, Kubernetes, local Docker) using the TAO Execution SDK, with job tracking, S3 I/O wrapping, and multi-node distributed training. <br>
