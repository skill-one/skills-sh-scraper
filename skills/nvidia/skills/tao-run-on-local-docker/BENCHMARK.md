# Skill Benchmark: tao-run-on-local-docker
...
- Dataset digest: `sha256:636dc2b85628c18a166abe0d194e72a2d57086e02bd667134128836ac0714aca` (skill-evaluator-dataset-snapshot/1)
- Attempts per task: 1
...
- **MEDIUM** SCHEMA/frontmatter_field_placement: Root field 'tags' is ignored; use 'metadata.tags' (`skills/platform/tao-run-on-local-docker/SKILL.md`)
