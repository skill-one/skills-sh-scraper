# Fixture: fm-storage-pragma-integrity-fail

This fixture corresponds to the failure mode `fm-storage-pragma-integrity-fail` documented in
...
2. cass doctor                              → finding emitted with fm-storage-pragma-integrity-fail
