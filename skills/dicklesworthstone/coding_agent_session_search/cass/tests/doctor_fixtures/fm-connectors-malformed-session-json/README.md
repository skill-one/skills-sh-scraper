# Fixture: fm-connectors-malformed-session-json

This fixture corresponds to the failure mode `fm-connectors-malformed-session-json` documented in
...
2. cass doctor                              → finding emitted with fm-connectors-malformed-session-json
