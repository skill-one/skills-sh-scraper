# Fixture: fm-search-embedder-registry-failure

This fixture corresponds to the failure mode `fm-search-embedder-registry-failure` documented in
...
2. cass doctor                              → finding emitted with fm-search-embedder-registry-failure
