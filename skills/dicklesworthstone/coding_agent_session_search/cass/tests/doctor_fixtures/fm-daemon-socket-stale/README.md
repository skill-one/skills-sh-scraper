# Fixture: fm-daemon-socket-stale

This fixture corresponds to the failure mode `fm-daemon-socket-stale` documented in
...
2. cass doctor                              → finding emitted with fm-daemon-socket-stale
