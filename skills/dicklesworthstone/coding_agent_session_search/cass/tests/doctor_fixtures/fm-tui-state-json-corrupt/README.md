# Fixture: fm-tui-state-json-corrupt

This fixture corresponds to the failure mode `fm-tui-state-json-corrupt` documented in
...
2. cass doctor                              → finding emitted with fm-tui-state-json-corrupt
