# Fixture: fm-bookmarks-stale-source-path

This fixture corresponds to the failure mode `fm-bookmarks-stale-source-path` documented in
...
2. cass doctor                              → finding emitted with fm-bookmarks-stale-source-path
