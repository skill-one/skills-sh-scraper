# Fixture: fm-storage-frankensqlite-openread-cursor

This fixture corresponds to the failure mode `fm-storage-frankensqlite-openread-cursor` documented in
...
2. cass doctor                              → finding emitted with fm-storage-frankensqlite-openread-cursor
