# Fixture: fm-connectors-aider-external-id-collision

This fixture corresponds to the failure mode `fm-connectors-aider-external-id-collision` documented in
...
2. cass doctor                              → finding emitted with fm-connectors-aider-external-id-collision
