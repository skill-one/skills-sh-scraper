# Fixture: fm-cli_robot-introspect-golden-drift

This fixture corresponds to the failure mode `fm-cli_robot-introspect-golden-drift` documented in
...
2. cass doctor                              → finding emitted with fm-cli_robot-introspect-golden-drift
