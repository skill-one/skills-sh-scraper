# Fixture: fm-indexer-semantic-vector-partial-build

This fixture corresponds to the failure mode `fm-indexer-semantic-vector-partial-build` documented in
...
2. cass doctor                              → finding emitted with fm-indexer-semantic-vector-partial-build
