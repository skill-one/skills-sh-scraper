# Fixture: fm-analytics-frankensqlite-aggregate-only

This fixture corresponds to the failure mode `fm-analytics-frankensqlite-aggregate-only` documented in
...
2. cass doctor                              → finding emitted with fm-analytics-frankensqlite-aggregate-only
