# Fixture: fm-sources-toml-malformed

This fixture corresponds to the failure mode `fm-sources-toml-malformed` documented in
...
2. cass doctor                              → finding emitted with fm-sources-toml-malformed
