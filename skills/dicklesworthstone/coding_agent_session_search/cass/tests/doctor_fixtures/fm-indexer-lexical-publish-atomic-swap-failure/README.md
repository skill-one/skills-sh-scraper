# Fixture: fm-indexer-lexical-publish-atomic-swap-failure

This fixture corresponds to the failure mode `fm-indexer-lexical-publish-atomic-swap-failure` documented in
...
2. cass doctor                              → finding emitted with fm-indexer-lexical-publish-atomic-swap-failure
