# Fixture: fm-storage-fixable-corruption

This fixture corresponds to the failure mode `fm-storage-fixable-corruption` documented in
...
2. cass doctor                              → finding emitted with fm-storage-fixable-corruption
