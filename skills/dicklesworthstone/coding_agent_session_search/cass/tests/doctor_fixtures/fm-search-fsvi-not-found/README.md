# Fixture: fm-search-fsvi-not-found

This fixture corresponds to the failure mode `fm-search-fsvi-not-found` documented in
...
2. cass doctor                              → finding emitted with fm-search-fsvi-not-found
