# Fixture: fm-cli_robot-schema-version-missing-doctor-root

This fixture corresponds to the failure mode `fm-cli_robot-schema-version-missing-doctor-root` documented in
...
2. cass doctor                              → finding emitted with fm-cli_robot-schema-version-missing-doctor-root
