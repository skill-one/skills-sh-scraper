# Fixture: fm-html_export-output-not-writable

This fixture corresponds to the failure mode `fm-html_export-output-not-writable` documented in
...
2. cass doctor                              → finding emitted with fm-html_export-output-not-writable
