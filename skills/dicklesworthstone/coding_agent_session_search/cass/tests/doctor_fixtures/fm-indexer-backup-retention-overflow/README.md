# Fixture: fm-indexer-backup-retention-overflow

This fixture corresponds to the failure mode `fm-indexer-backup-retention-overflow` documented in
...
2. cass doctor                              → finding emitted with fm-indexer-backup-retention-overflow
