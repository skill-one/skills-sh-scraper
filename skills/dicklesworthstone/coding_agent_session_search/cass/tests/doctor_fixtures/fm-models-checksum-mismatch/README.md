# Fixture: fm-models-checksum-mismatch

This fixture corresponds to the failure mode `fm-models-checksum-mismatch` documented in
...
2. cass doctor                              → finding emitted with fm-models-checksum-mismatch
