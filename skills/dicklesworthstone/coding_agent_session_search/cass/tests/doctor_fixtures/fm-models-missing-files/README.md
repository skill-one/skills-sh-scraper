# Fixture: fm-models-missing-files

This fixture corresponds to the failure mode `fm-models-missing-files` documented in
...
2. cass doctor                              → finding emitted with fm-models-missing-files
