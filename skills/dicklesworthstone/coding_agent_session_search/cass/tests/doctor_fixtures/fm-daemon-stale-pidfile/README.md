# Fixture: fm-daemon-stale-pidfile

This fixture corresponds to the failure mode `fm-daemon-stale-pidfile` documented in
...
2. cass doctor                              → finding emitted with fm-daemon-stale-pidfile
