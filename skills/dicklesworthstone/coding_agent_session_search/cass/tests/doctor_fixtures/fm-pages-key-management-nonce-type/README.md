# Fixture: fm-pages-key-management-nonce-type

This fixture corresponds to the failure mode `fm-pages-key-management-nonce-type` documented in
...
2. cass doctor                              → finding emitted with fm-pages-key-management-nonce-type
