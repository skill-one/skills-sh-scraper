# Fixture: fm-search-empty-fast-unwrap

This fixture corresponds to the failure mode `fm-search-empty-fast-unwrap` documented in
...
2. cass doctor                              → finding emitted with fm-search-empty-fast-unwrap
