# Fixture: fm-analytics-token-rollup-gap

This fixture corresponds to the failure mode `fm-analytics-token-rollup-gap` documented in
...
2. cass doctor                              → finding emitted with fm-analytics-token-rollup-gap
