# Fixture: fm-storage-stale-wal-shm

This fixture corresponds to the failure mode `fm-storage-stale-wal-shm` documented in
...
2. cass doctor                              → finding emitted with fm-storage-stale-wal-shm
