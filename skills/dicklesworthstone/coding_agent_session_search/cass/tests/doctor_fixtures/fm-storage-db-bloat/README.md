# Fixture: fm-storage-db-bloat

This fixture corresponds to the failure mode `fm-storage-db-bloat` documented in
...
2. cass doctor                              → finding emitted with fm-storage-db-bloat
