...
Documentation setup accepts an explicit target and requested artifacts. It preserves
...
Documentation setup inspects those paths, asks only for product or goal content that is
...
If `PRODUCT.md` and `README.md` already exist, Documentation setup leaves them byte-for-
...
**Caller asks:** Show what Documentation setup would need to create in `/work/widget`;
do not write anything.

Documentation setup reports which requested paths exist and which are missing. It does
