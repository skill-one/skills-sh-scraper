...
> **For schema types**, prefer your generated types file first (e.g. `src/gql/graphql.ts`). It contains the full Saleor schema as TypeScript types, generated via API introspection. Only check the Saleor core source when you need to understand resolver behavior.
