...
- Graphics quality ladder (MSAA, shadow atlas, post-FX) and UI density tables live in [desktop-port-deep.md](adapt-mobile-to-desktop-desktop-port-deep.md) — open when port procedure rows are insufficient.
