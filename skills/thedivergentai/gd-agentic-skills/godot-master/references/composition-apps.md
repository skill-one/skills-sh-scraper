...
**MANDATORY:** Validate new components with [comp_rock_test_boilerplate.gd](../scripts/composition_apps_comp_rock_test_boilerplate.gd).
...
### [comp_health_component.gd](../scripts/composition_apps_comp_health_component.gd) / [comp_hitbox_component.gd](../scripts/composition_apps_comp_hitbox_component.gd)
...
**MANDATORY:** Extend patterns from [comp_orchestrator_base.gd](../scripts/composition_apps_comp_orchestrator_base.gd).

| Concept | App/UI Example |
|---------|----------------|
| Orchestrator | `UserProfile.gd` / Editor dock root |
| Logic component | `AuthValidator` |
| VLS | `AuthVisualSyncer` via [comp_logic_visual_syncer.gd](../scripts/composition_apps_comp_logic_visual_syncer.gd) |
...
1. **MANDATORY** [comp_persistence_component.gd](../scripts/composition_apps_comp_persistence_component.gd) on the Orchestrator (or a dedicated Saveable child) — `add_to_group("Saveable")` + `get_save_data()`.
...
**MANDATORY** [comp_logic_visual_syncer.gd](../scripts/composition_apps_comp_logic_visual_syncer.gd) — logic never calls `AnimationPlayer.play()`.
