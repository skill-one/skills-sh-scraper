...
- [dialogue_graph_editor.gd](../scripts/dialogue_system_dialogue_graph_editor.gd) — `@tool` GraphEdit auditor (editor-only)
- [dialogue_lipsync.gd](../scripts/dialogue_system_dialogue_lipsync.gd) — TTS boundary lipsync helper
- [dialogue_stat_logger.gd](../scripts/dialogue_system_dialogue_stat_logger.gd) — choice analytics Logger
...
- **GraphEdit auditor:** [dialogue_graph_editor.gd](../scripts/dialogue_system_dialogue_graph_editor.gd) (`@tool`) — export to Resource/JSON for runtime.
- **Audio-driven lines:** [dialogue_lipsync.gd](../scripts/dialogue_system_dialogue_lipsync.gd) — TTS boundaries; still allow skip.
- **Analytics:** [dialogue_stat_logger.gd](../scripts/dialogue_system_dialogue_stat_logger.gd) — `[CHOICE]` log prefix; no PII.

> **MANDATORY** for GraphEdit tooling, TTS/lipsync, analytics, and moved inline manager/UI tutorials: [elite-dialogue-patterns.md](dialogue-system-elite-dialogue-patterns.md). **Do NOT Load** for Resource Autoload golden path only.
