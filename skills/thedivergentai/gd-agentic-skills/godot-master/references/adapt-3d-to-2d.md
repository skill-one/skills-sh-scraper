...
- **NEVER use orthographic Camera3D as "2D mode"** — WHY: You still pay 3D transform/lighting costs and miss CanvasItem batching. Use Camera2D + 2D nodes ([`ortho_simulation.gd`](../scripts/adapt_3d_to_2d_ortho_simulation.gd) only for simulated height).
...
- **NEVER treat ground and air hits as the same Area2D overlap** — In 2.5D, a ground slash must not hit jumping targets. WHY: 2D physics has no Z. Use [`hitbox_depth_manager.gd`](../scripts/adapt_3d_to_2d_hitbox_depth_manager.gd) height AABB checks.
- **NEVER fight Y-sort with per-sprite `z_index` spam** — WHY: Ownership of sort order belongs on the Y-sorted parent. Use [`depth_sorting_y_sort.gd`](../scripts/adapt_3d_to_2d_depth_sorting_y_sort.gd); manual z_index drifts every frame.
...
### [ortho_simulation.gd](../scripts/adapt_3d_to_2d_ortho_simulation.gd)
Simulates 3D Z-axis height in 2D top-down games. Handles vertical velocity, gravity, sprite offset, and shadow scaling.

### [projection_utils.gd](../scripts/adapt_3d_to_2d_projection_utils.gd)
...
### [isometric_math_core.gd](../scripts/adapt_3d_to_2d_isometric_math_core.gd)
...
### [depth_sorting_y_sort.gd](../scripts/adapt_3d_to_2d_depth_sorting_y_sort.gd)
Expert dynamic Z-index Y-Sort script for fake 3D sorting isolated trees matching CanvasItem `_update_sorting()`.

### [jump_z_axis_sim.gd](../scripts/adapt_3d_to_2d_jump_z_axis_sim.gd)
...
### [parallax_depth_camera.gd](../scripts/adapt_3d_to_2d_parallax_depth_camera.gd)
...
### [hitbox_depth_manager.gd](../scripts/adapt_3d_to_2d_hitbox_depth_manager.gd)
...
### [fake_3d_shadows.gd](../scripts/adapt_3d_to_2d_fake_3d_shadows.gd)
...
### [billboard_sprite_manager.gd](../scripts/adapt_3d_to_2d_billboard_sprite_manager.gd)
...
### [nav_region_flattening.gd](../scripts/adapt_3d_to_2d_nav_region_flattening.gd)
...
### [ortho_to_perspective_fx.gd](../scripts/adapt_3d_to_2d_ortho_to_perspective_fx.gd)
...
### [2d_lighting_normals.gd](../scripts/adapt_3d_to_2d_2d_lighting_normals.gd)
...
**MANDATORY** when baking multi-angle sprites from GLB/scenes: [`model_to_sprite_bake.gd`](../scripts/adapt_3d_to_2d_model_to_sprite_bake.gd) (`@tool` SubViewport baker).
...
**NEVER** drive sort with per-sprite `z_index = int(global_position.y)` — that contradicts Y-sort ownership. **MANDATORY** [`depth_sorting_y_sort.gd`](../scripts/adapt_3d_to_2d_depth_sorting_y_sort.gd): enable `y_sort_enabled` on the parent and keep children at default relative z.
