...
Issue categories are best-effort (English-locale chktex message keywords); a non-English chktex locale falls back to a single "other" category without affecting issue counts or severity.
