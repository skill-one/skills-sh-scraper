...
class LatexParser(DocumentParser):
    ...
    SECTION_PATTERNS = {
        ...
        "organization": r"\\section*?{.*(?:Paper\s+Organization|Roadmap|Outline)}",
        "summary": r"\\section*?{.*(?:Chapter|Section)\s+Summary}",
    ...
    SECTION_TITLE_RULES: list[tuple[str, int, str]] = [
        ...
        ("organization", 3, r"paper (?:is )?organized|roadmap|outline of this"),
        ("summary", 3, r"^(?:chapter|section) summary$"),
