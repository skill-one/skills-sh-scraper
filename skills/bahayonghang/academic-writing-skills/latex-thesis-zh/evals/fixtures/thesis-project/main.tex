...
\author{测试作者} % seed: blind-review R1 作者字段（generic \author 宏）
\thusetup{supervisor = {测试导师}} % seed: blind-review R1 导师字段（thuthesis 键值）
...
\input{chapters/achievements} % seed: blind-review R2 成果章
\input{chapters/acknowledgement} % seed: blind-review R1 致谢章
