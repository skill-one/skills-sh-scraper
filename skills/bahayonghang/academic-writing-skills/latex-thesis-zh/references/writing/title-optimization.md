...
| 要素 | 作用 | 示例 |
|------|------|------|
| 对象 | 说明研究落在哪个过程、系统、指标或场景上 | 非平稳工业过程、水泥粉磨过程、单位电耗、比表面积 |
| 问题/任务 | 说明本章解决什么学术或工程问题 | 异常监测、根因诊断、时间序列预测、运行优化 |
| 方法/路径 | 说明本章用什么方法或技术路径解决问题 | 自适应方法、异构数据融合模型、多步优化算法、系统设计 |
