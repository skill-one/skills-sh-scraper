...
Conservative-wording reference for Typst papers (English / bilingual). The goal is
**not** timid prose — it is to state evidence strength precisely: strong evidence earns
strong wording, weak evidence gets weak wording.

## Scope

This guide decides **how to word a claim once its evidence strength is known** — which
verb / qualifier to pick so the sentence does not outrun the evidence. Settle evidence
sufficiency first (does the visible figure / metric / citation support the claim at all),
then pick wording here. Where substance and phrasing seem to conflict, substance wins.
